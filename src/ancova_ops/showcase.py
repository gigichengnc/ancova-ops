...
def render_showcase_markdown(payload: dict[str, Any]) -> str:
    ...
    return f"""# ANCOVA Ops v1.0 Portfolio Showcase
...
> ANCOVA Ops is not designed to make management decisions. It is designed to make
> unsupported management conclusions harder to reach.

This report is generated by `ancova-showcase`. It demonstrates the completed research
...
ANCOVA Ops reproducibly connects **Operate → Audit → Evaluate**: explainable routing,
